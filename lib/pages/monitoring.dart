...
class _MonitoringState extends State<Monitoring> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('加载出错：${response.statusCode}')));
  ...
  Widget _buildExpandableTile(Map<String, dynamic> node, int level, String name, int count, Color color, bool isLastLevel) {
...
// 自定义可展开Tile组件，避免ExpansionTile的兼容性问题
